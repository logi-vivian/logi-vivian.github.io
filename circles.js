...
function generateAllElements() {
    ...
    for(let a = 0; a < totalRingElements; a++){
        ...
        let elementScale = getRandomNumber(1.5, 1);
        let scaleDuration = getRandomNumber(3000, 1000);

        // path params
        let pathValOne = getRandomNumber(11, 0);
        let pathValTwo = getRandomNumber(11, 0);
        ...
        for (let i = 1; i <= totalCircleElements; i++) {
            ...
            circleElement.setAttribute('opacity', `0.5`);
